...
func (_Delegationmanager *DelegationmanagerCaller) WITHDRAWALDELAY(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Delegationmanager.contract.Call(opts, out, "WITHDRAWAL_DELAY")
	return *ret0, err
}
...
//
// Solidity: function WITHDRAWAL_DELAY() constant returns(uint256)
func (_Delegationmanager *DelegationmanagerSession) WITHDRAWALDELAY() (*big.Int, error) {
	return _Delegationmanager.Contract.WITHDRAWALDELAY(&_Delegationmanager.CallOpts)
}

// WITHDRAWALDELAY is a free data retrieval call binding the contract method 0x0ebb172a.
//
// Solidity: function WITHDRAWAL_DELAY() constant returns(uint256)
func (_Delegationmanager *DelegationmanagerCallerSession) WITHDRAWALDELAY() (*big.Int, error) {
	return _Delegationmanager.Contract.WITHDRAWALDELAY(&_Delegationmanager.CallOpts)
}
...
// FilterUnBonding is a free log retrieval operation binding the contract event 0x2325edda12819f74fa130d3724468d4e2fb928318dfb2d139cf7d183262380ca.
//
// Solidity: event UnBonding(uint256 indexed delegatorId, uint256 indexed validatorId)
func (_Delegationmanager *DelegationmanagerFilterer) FilterUnBonding(opts *bind.FilterOpts, delegatorId []*big.Int, validatorId []*big.Int) (*DelegationmanagerUnBondingIterator, error) {
	...
	logs, sub, err := _Delegationmanager.contract.FilterLogs(opts, "UnBonding", delegatorIdRule, validatorIdRule)
	if err != nil {
		return nil, err
	}
...
// WatchUnBonding is a free log subscription operation binding the contract event 0x2325edda12819f74fa130d3724468d4e2fb928318dfb2d139cf7d183262380ca.
//
// Solidity: event UnBonding(uint256 indexed delegatorId, uint256 indexed validatorId)
func (_Delegationmanager *DelegationmanagerFilterer) WatchUnBonding(opts *bind.WatchOpts, sink chan<- *DelegationmanagerUnBonding, delegatorId []*big.Int, validatorId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Delegationmanager.contract.WatchLogs(opts, "UnBonding", delegatorIdRule, validatorIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseUnBonding is a log parse operation binding the contract event 0x2325edda12819f74fa130d3724468d4e2fb928318dfb2d139cf7d183262380ca.
//
// Solidity: event UnBonding(uint256 indexed delegatorId, uint256 indexed validatorId)
